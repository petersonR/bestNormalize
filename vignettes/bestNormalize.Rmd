...
The ORQ normalization technique is based on the following transformation (originally developed in 1952 by Van der Waerden in "Order tests for the two sample problem and their power"):
...
2) It takes considerably longer to eestimate than the in-sample statistic, and
