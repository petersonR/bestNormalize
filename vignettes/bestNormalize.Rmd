...
priceBN <- bestNormalize(autotrader$price, D_max = .05)
mileageBN <- bestNormalize(autotrader$mileage, D_max = .05)
yearsoldBN <- bestNormalize(autotrader$yearsold, D_max = .05)
