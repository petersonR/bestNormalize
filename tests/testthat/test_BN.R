...
test_that('BestNormalize transformations work with positive data', {
  expect_equal(BNobject$x.t, predict.BN(BNobject))
  expect_equal(BNobject$x, predict.BN(BNobject, inverse = T))
  expect_equal(BNobject2$x.t, predict.BN(BNobject2))
  expect_equal(BNobject2$x, predict.BN(BNobject2, inverse = T))
  expect_equal(BNobject4$x.t, predict.BN(BNobject4))
  expect_equal(BNobject4$x, predict.BN(BNobject4, inverse = T))
})
